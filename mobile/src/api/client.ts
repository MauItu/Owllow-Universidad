...
export const debtsApi = {
  ...
  forgive: (id: number) => api.post(`/debts/${id}/forgive`).then((r) => r.data),
...
export const splitsApi = {
  ...
  updateExpense: (groupId: number, expenseId: number, data: SplitExpenseInput) =>
    api.put<SplitExpense>(`/splits/${groupId}/expenses/${expenseId}`, data).then((r) => r.data),
